...
const set: any = async (req: any) => {
  ...
  try{
    ...
    if( process.env.NODE_ENV == 'development' ){
      req.session.user_id = (req.session.user_id || '6015eab62947494ed432b78f');
      req.params.clientId = (req.params.clientId || '6016734e7e200b40e8e17765');
      req.params.eventId = (req.params.eventId || '601674247e200b40e8e17767');
    }
